...
# 680 users found this helpful
t=int(input()) # no of test cases
for i in range(t):
    x=int(input()) # no of elements
    n=list(map(int, input().split()))# learn this , this takes input elements as per need
    print(max(n)) # thsi code only works on hacker rank and leet